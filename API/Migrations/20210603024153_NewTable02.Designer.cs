...
namespace API.Migrations
{
    ...
    [Migration("20210603024153_NewTable02")]
    partial class NewTable02
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.ViewModel.RegisterVM", b =>
                {
                    b.Property<int?>("AccountNIK")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Models.AccountRole", b =>
                {
                    b.HasOne("API.Models.Account", "Account")
                        .WithOne("AccountRole")
                        .HasForeignKey("API.Models.AccountRole", "AccountNIK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AccountRoleRole", b =>
                {
                    b.HasOne("API.Models.AccountRole", null)
                        .WithMany()
